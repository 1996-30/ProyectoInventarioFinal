        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <?php include("includes/topbar.php") ?>
                ...
                <?php
                            $query = "SELECT SUM(cantidad*precio_unitario) as total FROM inventario1;";
              ...
              ?>
               <?php }?>
                       ...
                       <!--  otro card -->
                        ...
                        $query = "SELECT SUM(cantidad) as cantidad FROM inventario1;";
                        $result= $conn->query($query);
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Cantidad de Productos Disponibles</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-1000">'
                                          .'Total '  .number_format($fila['cantidad']).


                                            '</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-brands fa-product-hunt  fa-2x text-gray-900"></i>
              ...
              ?>
                      ...
                      <?php
                        ...
                        $query = "SELECT count(id_categoria) as categoria FROM categorias1;";
                        $result= $conn->query($query);
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                                .'Total: '.number_format($fila['categoria']).
                                                '</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-solid fa-folder fa-2x text-gray-300"></i>
                        ...
                        $query = "SELECT count(id_proveedor) as proveedort FROM proveedores1;";
                        $result= $conn->query($query);
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                                .'Total: '.number_format($fila['proveedort']).
                                                '</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-solid fa-circle-user fa-2x text-gray-300"></i>
                        ...
                        $query = "SELECT c.descripcion,
                                        ...
                                        FROM inventario1 as i
                                            INNER JOIN categorias1 AS c ON (i.categoria_id=c.id_categoria)
                                            WHERE c.descripcion='ALMACENAMIENTO'
                                ...
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                   Total Categoria Almacenamiento </div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">'
                            ...
                            function dibujarGrafico() {
                                ...
                                .then(data => {
                                    ...
                                    var dataTable = google.visualization.arrayToDataTable(data);
                                            ...
                                            //Opciones del grafico 
                                            var options = {
                                            title: 'Costo de Productos por Categoria',
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                 ...
                                 <div id="graficoCol2">Gráfico 0</div>
